...
val button : cap -> ?id:int -> ?style:Style.t -> string -> bool
val checkbox : cap -> ?id:int -> ?style:Style.t -> string -> bool
...
val radio : cap -> ?id:int -> ?style:Style.t -> ('a * string) list -> 'a option
