...
let size ~io {text;width}  = text_area_size ~io ~font:Font.default ?width ~size:font_size text

let render ~io {text;width} box =
  draw_text ~io ~color:fg ~font:Font.default ?width  ~size:font_size text (Box.o box)
